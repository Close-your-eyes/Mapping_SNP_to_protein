...
```{r plot exons against genomic seq and cds, fig.width=9, fig.height=5, warning=F, cache=T}
```
...
```{r plot exons against genomic seq and cds 2, fig.width=9, fig.height=5, warning=F, cache=T}
```
